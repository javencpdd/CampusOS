...
BEGIN
    ...
    FROM unnest(ARRAY[
        ...
        'identity_email_challenges', 'identity_challenge_rate_limits', 'identity_account_recovery_cases',
    ...
    FROM unnest(ARRAY[
        ...
        'fk_accounts_user', 'fk_identity_email_challenge_account', 'fk_identity_recovery_case_user',
