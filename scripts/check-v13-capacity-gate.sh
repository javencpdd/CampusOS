...
test -f docs/项目计划v13/evidence/v13-capacity-budget.json
grep -q '"max_p95_regression_ratio"' docs/项目计划v13/evidence/v13-capacity-budget.json
test -f docs/项目计划v13/evidence/v13-capacity-drill-budget.json
grep -q '"max_p95_absolute_regression_ms"' docs/项目计划v13/evidence/v13-capacity-drill-budget.json
