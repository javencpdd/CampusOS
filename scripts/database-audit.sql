...
('invalid identity challenge rate state', 'identity', (SELECT count(*) FROM identity_challenge_rate_limits WHERE scope NOT IN ('email_minute', 'email_day', 'ip_hour') OR request_count < 0 OR request_count > 10000)),
