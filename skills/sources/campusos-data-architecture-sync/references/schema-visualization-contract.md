...
3. `admin/src/modules/architecture/pages/SystemArchitectureView.vue` presents a reviewed, Chinese-language explanation of those tables and data directories.
