...
| Skill invocation, structure, validation, synchronization | `docs/skills/` | Link the Skills index from `docs/README.md`; do not list every Skill in root README. |
...
`docs/README.md` is the documentation portal. A category may also provide its own `README.md`, for example `docs/skills/README.md`.
