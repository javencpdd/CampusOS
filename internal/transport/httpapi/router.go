...
func Build(d Dependencies) *Router {
	...
	authenticated.Use(middleware.JWTAuth(d.JWT, d.SessionVerifier))
	{
		...
		authenticated.GET("/assets", d.RichText.ListUserAssets)
		authenticated.GET("/assets/:id/download", d.RichText.DownloadMyUserAsset)
		authenticated.POST("/assets/:id/pdf-invocations", d.RichText.CreatePersonalAssetPDFInvocation)
		authenticated.POST("/assets/:id/trash", d.RichText.TrashUserAsset)
		...
		authenticated.DELETE("/richtext/articles/:id/attachments/:attachment_id", d.RichText.RemoveAttachment)
		authenticated.GET("/richtext/articles/:id/attachments/:attachment_id/download", d.RichText.DownloadAttachment)
		...
		authenticated.GET("/plugin-capabilities", d.Plugin.CapabilityCatalog)
		authenticated.GET("/plugin-authorizations/:name", d.Plugin.MyAuthorizationOverview)
		authenticated.PUT("/plugin-authorizations/:name/versions/:version_id/consents/:capability", d.Plugin.SetMyCapabilityConsent)
		authenticated.POST("/plugin-authorizations/:name/versions/:version_id/delegations", d.Plugin.IssueMyDelegation)
		authenticated.DELETE("/plugin-authorizations/:name/delegations/:delegation_id", d.Plugin.RevokeMyDelegation)
		authenticated.GET("/plugin-authorizations/:name/secrets", d.Plugin.ListMyPluginSecrets)
		authenticated.PUT("/plugin-authorizations/:name/secrets/:secret", d.Plugin.SetMyPluginSecret)
		authenticated.DELETE("/plugin-authorizations/:name/secrets/:secret", d.Plugin.RevokeMyPluginSecret)
		...
		authenticated.GET("/plugin-market/sources", d.Plugin.MarketplaceSources)
		authenticated.GET("/plugin-market/sources/:source_id/plugins", d.Plugin.SearchMarketplace)
		authenticated.POST("/plugin-market/requests", d.Plugin.RequestMarketplaceInstall)
	...
	admin.Use(middleware.JWTAuth(d.JWT, d.SessionVerifier))
	{
		...
		admin.Permission("plugin", "read").GET("/plugins/:name/authorization", d.Plugin.AdminAuthorizationOverview)
		admin.Permission("plugin", "read").GET("/plugins/:name/authorization/decisions", d.Plugin.AdminAuthorizationDecisions)
		admin.Permission("plugin", "configure").POST("/plugins/:name/authorization/sync", d.Plugin.SyncPluginAuthorization)
		admin.Permission("plugin", "configure").PUT("/plugins/:name/versions/:version_id/grants/:capability", d.Plugin.AdminSetCapabilityGrant)
		admin.Permission("plugin", "configure").GET("/plugins/:name/secrets", d.Plugin.ListSystemPluginSecrets)
		admin.Permission("plugin", "configure").PUT("/plugins/:name/secrets/:secret", d.Plugin.SetSystemPluginSecret)
		admin.Permission("plugin", "configure").DELETE("/plugins/:name/secrets/:secret", d.Plugin.RevokeSystemPluginSecret)
		...
		admin.Permission("plugin", "read").GET("/plugin-market/admin/sources", d.Plugin.AdminMarketplaceSources)
		admin.Permission("plugin", "configure").PUT("/plugin-market/admin/sources/:source_id", d.Plugin.AdminSaveMarketplaceSource)
		admin.Permission("plugin", "configure").DELETE("/plugin-market/admin/sources/:source_id", d.Plugin.AdminDeleteMarketplaceSource)
		...
		admin.PermissionCode("personal_space.asset.read_audit").Operation("http.personal_space.asset.governance_summary").GET("/admin/assets/summary", d.RichText.AssetGovernanceSummary)
		admin.PermissionCode("personal_space.asset.manage").Operation("http.personal_space.asset.quarantine").POST("/admin/assets/:id/quarantine", d.RichText.AdminQuarantineUserAsset)
		admin.PermissionCode("personal_space.asset.manage").Operation("http.personal_space.asset.restore").POST("/admin/assets/:id/restore", d.RichText.AdminRestoreQuarantinedUserAsset)
		admin.PermissionCode("personal_space.asset.manage").Operation("http.personal_space.asset.purge_preview").GET("/admin/assets/:id/purge-preview", d.RichText.AdminPreviewUserAssetPurge)
		admin.PermissionCode("personal_space.asset.manage").Operation("http.personal_space.asset.purge").DELETE("/admin/assets/:id/purge", d.RichText.AdminPurgeUserAsset)
