...
const databaseTables: DbTable[] = [
  ...
  },
  {
    ...
    fields: ["name", "url", "events", "enabled"],
    migration: "000011",
    relationshipNote: "一个端点可产生多条投递记录。",
  },
  {
    ...
    fields: ["endpoint_id", "event_type", "status", "attempts"],
    migration: "000011 + 000016",
    relationshipNote: "endpoint_id 由指向 webhook_endpoints.id 的外键保护。",
  },
  {
    name: "mcp_audit_logs",
    title: "MCP 调用审计",
