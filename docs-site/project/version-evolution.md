...
`v0.13.0`；v0.14-dev 已确认开发收尾。v1.0 的计划内 P0/P1 仓库实现已完成，当前处于发布候选证据收集阶段。
...
| v1.1 | 图文附件与 PDF 插件 | 已形成最小 User Asset、文章附件、Plugin UI v2、认证 Range 和第一方 PDF Viewer 正式计划；代码尚未实施 |
