...
| 设计新的权限能力 | [系统架构](/guide/architecture) 和仓库内 `v0.10权限管理设计与使用入门.md` |
...
| 理解历史计划、文档有效性和下一步 | [v0.1-v0.14 版本演进](/project/version-evolution)、[文档状态与历史替代](/project/document-lifecycle)、[当前规划与后续路线](/project/current-roadmap) |
